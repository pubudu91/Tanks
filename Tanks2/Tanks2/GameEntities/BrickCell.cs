            ...
            set
            {
                /*switch (value)
                {
                    case DamageLevel.DAMAGE0:
                        texture = Util.Content.Load<Texture2D>("brick");
                        break;
                    case DamageLevel.DAMAGE25:
                        texture = Util.Content.Load<Texture2D>("brick_25");
                        break;
                    case DamageLevel.DAMAGE50:
                        texture = Util.Content.Load<Texture2D>("brick_50");
                        break;
                    case DamageLevel.DAMAGE75:
                        texture = Util.Content.Load<Texture2D>("brick_75");
                        break;
                    case DamageLevel.DAMAGE100:
                        texture = Util.Content.Load<Texture2D>("brick_100"); // TODO: add the texture of a blank cell here
                        break;
                }*/
